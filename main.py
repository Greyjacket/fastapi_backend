...
import users.models, properties.models, attorneys.models, agents.models, contracts.models
import users.main, properties.main, attorneys.main, agents.main, contracts.main
